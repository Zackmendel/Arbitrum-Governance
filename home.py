...
with st.sidebar:
  ...
  - [2. SNAPSHOT PROPOSAL AND VOTING STATS OF ARBITRUM GOVERNANCE](#2-snapshot-proposal-and-voting-stats-of-arbitrum-governance)
    - [Who publishes proposals most often(Snapshot)?](#who-publishes-proposals-most-often-snapshot)
    - [Which categories of users take part more often?](#which-categories-of-users-take-part-more-often-snapshot)
  - [3. Data Sources](#3-data-sources)
      - [Onchain](#overall-proposal-id-on-chain-stats-on-arbitrum)
      - [Snapshot](#overall-proposal-id-stats-for-the-first-1000-proposals-by-vote-count-of-arbitrum-on-snapshot)
